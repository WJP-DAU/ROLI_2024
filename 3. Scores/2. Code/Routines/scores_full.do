/*=================================================================================================================
Project:		Global ROLI cleaning and analysis
...
Description:
This routine will create the factor, sub-factor and other scores using the QRQ, GPP and TPS.
...
*f_1_1 ;
egen double f_1_1_A=rowmean(all_q1_norm
all_q2_norm
all_q20_norm
all_q21_norm ) ; 

egen double f_1_1_B=rowmean( 
q45a_G1_norm ) ; 

egen double f_1_1=rowmean(f_1_1_A f_1_1_B) ; 

*f_1_2 ;
egen double f_1_2_A=rowmean(
all_q2_norm
all_q3_norm
cc_q25_norm
all_q4_norm
...
egen double f_1_2=rowmean(f_1_2_A f_1_2_B) ; 

*f_1_3 ;
egen double f_1_3=rowmean(
cc_q33_norm
all_q9_norm
cj_q38_norm
cj_q36c_norm
...
*f_1_4 ;
egen double f_1_4_1_A=rowmean(
all_q52_norm
all_q53_norm
all_q93_norm) ; 

egen double f_1_4_1_B=rowmean(
q4_norm_2016
q43_G2_norm ); 

egen double f_1_4_1=rowmean(f_1_4_1_A f_1_4_1_B) ; 


egen double f_1_4_2=rowmean(
all_q10_norm
all_q11_norm) ; 

egen double f_1_4_3=rowmean( 
all_q12_norm) ; 

egen double f_1_4_4_A=rowmean(
cj_q36b_norm
cj_q36a_norm
cj_q9_norm
cj_q8_norm) ; 

egen double f_1_4_4_B=rowmean(
q45c_G2_norm
q48d_G1_norm ) ; 

egen double f_1_4_4=rowmean(f_1_4_4_A f_1_4_4_B) ; 


egen double f_1_4=rowmean( f_1_4_1 f_1_4_2 f_1_4_3 f_1_4_4 ) ;
...
egen double f_1_5_1=rowmean(f_1_5_1_A f_1_5_1_B) ; 


egen double f_1_5_2_A=rowmean(
all_q15_norm
all_q16_norm
all_q17_norm
cj_q10_norm
...
egen double f_1_5_2_B=rowmean(
q46e_G2_norm
q46c_G1_norm ); 

egen double f_1_5_2=rowmean(f_1_5_2_A f_1_5_2_B) ; 


egen double f_1_5_3_A=rowmean(
all_q19_norm
q46f_G2_norm) ; 

egen double f_1_5_3_B=rowmean(
all_q20_norm
all_q21_norm) ; 

egen double f_1_5_3_C=rowmean(
f_1_5_3_B
q46g_G2_norm); 

egen double f_1_5_3=rowmean(f_1_5_3_A f_1_5_3_C) ;  


egen double f_1_5=rowmean(f_1_5_1 f_1_5_2 f_1_5_3) ;


*f_1_6 ;
egen double f_1_6_A=rowmean(
all_q23_norm
q46d_G1_norm
); 

egen double f_1_6_B=rowmean(
all_q27_norm
q46e_G1_norm) ; 

egen double f_1_6=rowmean(
all_q22_norm
all_q24_norm
all_q25_norm
all_q26_norm
...
egen double f_2_1_1=rowmean(f_2_1_1_A f_2_1_1_B) ; 
...
egen double f_2_1_2_1=rowmean(f_2_1_2_1_A f_2_1_2_1_B) ; 
...
egen double f_2_1_2_2=rowmean(f_2_1_2_2_A f_2_1_2_2_B) ; 
...
egen double f_2_2=rowmean(f_2_2_1 f_2_2_2) ; 
...
egen double f_2_3=rowmean(f_2_3_A f_2_3_B) ; 
...
egen double f_3_1=rowmean(f_3_1_1 f_3_1_2) ; 

*f_3_2 ;
egen double f_3_2_1=rowmean( 
q6a_norm
q7a_norm
q7b_norm
q7c_norm
...
egen double f_3_2_4=rowmean( q6c_norm
cc_q39c_norm
cc_q39e_norm ) ; 

egen double f_3_2_5=rowmean( 
all_q40_norm
all_q41_norm
all_q42_norm
all_q43_norm
...
egen double f_3_2=rowmean(f_3_2_1 f_3_2_2 f_3_2_3 f_3_2_4 f_3_2_5) ; 

*f_3_3 ;
egen double f_3_3_1_1_A=rowmean(
all_q13_norm
all_q14_norm) ; 

egen double f_3_3_1_1_B=rowmean(
q46c_G2_norm) ; 

egen double f_3_3_1_1=rowmean(f_3_3_1_1_A f_3_3_1_1_B) ; 

egen double f_3_3_1_2_A=rowmean( 
all_q15_norm
all_q16_norm
all_q17_norm
cj_q10_norm
...
egen double f_3_3_1_2_B=rowmean( 
q46e_G2_norm
q46c_G1_norm); 

egen double f_3_3_1_2=rowmean(f_3_3_1_2_A f_3_3_1_2_B) ; 


egen double f_3_3_1_3_A=rowmean( 
all_q19_norm
q46f_G2_norm); 

egen double f_3_3_1_3_B=rowmean( 
all_q20_norm
all_q21_norm) ; 

egen double f_3_3_1_3_C=rowmean( 
f_3_3_1_3_B
q46g_G2_norm ); 

egen double f_3_3_1_3=rowmean(f_3_3_1_3_A f_3_3_1_3_C) ; 


egen double f_3_3_1=rowmean(f_3_3_1_1 f_3_3_1_2 f_3_3_1_3) ; 
...
egen double f_3_3_2=rowmean(f_3_3_2_1 f_3_3_2_2) ; 
...
egen double f_4_3_2=rowmean(f_4_3_2_1 q48c_G1_norm); 
...
egen double f_4_4_2=rowmean(f_4_4_2_A f_4_4_2_B) ; 
...
egen double f_4_5=rowmean(f_4_5_A f_4_5_B) ; 
...
egen double f_4_7=rowmean(f_4_7_A f_4_7_B) ; 
...
egen double f_5_1=rowmean(f_5_1_1 f_5_1_2 f_5_1_3 f_5_1_4 f_5_1_5) ; 
...
egen double f_6_2_2_1=rowmean(f_6_2_2_1_A f_6_2_2_1_B) ; 
...
egen double f_6_2_2_2=rowmean(f_6_2_2_2_A f_6_2_2_2_B) ; 
...
egen double f_7_1_5=rowmean(f_7_1_5_A f_7_1_5_B); 
...
egen double f_7_5=rowmean(f_7_5_1 f_7_5_2) ; 
...
egen double f_7_6=rowmean(f_7_6_1 f_7_6_2) ; 
...
egen double f_7_7=rowmean(f_7_7_1 f_7_7_2 f_7_7_3 f_7_7_4) ; 
...
egen double f_8_1_1_2=rowmean(
cj_q25a_norm
cj_q25b_norm
cj_q25c_norm); 

egen double f_8_1_1=rowmean(f_8_1_1_1 f_8_1_1_2) ; 
...
egen double f_8_2_2=rowmean(f_8_2_2_A f_8_2_2_B) ; 
...
egen double f_8_4_1=rowmean(f_8_4_1_A f_8_4_1_B); 
...
egen double f_8_5_1=rowmean(f_8_5_1_A f_8_5_1_B); 
...
egen double f_8_5_2=rowmean(f_8_5_2_A f_8_5_2_B); 
...
* Factor Scores ;
egen double f_1=rowmean(f_1_1 f_1_2 f_1_3 f_1_4 f_1_5 f_1_6)
