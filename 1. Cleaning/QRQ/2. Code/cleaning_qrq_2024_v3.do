...
foreach v in f_1_2 f_1_3 f_1_4 f_1_5 f_1_6 f_1_7 f_2_1 f_2_2 f_2_3 f_2_4 f_3_1 f_3_2 f_3_3 f_3_4 f_4_1 f_4_2 f_4_3 f_4_4 f_4_5 f_4_6 f_4_7 f_4_8 f_5_3 f_6_1 f_6_2 f_6_3 f_6_4 f_6_5 f_7_1 f_7_2 f_7_3 f_7_4 f_7_5 f_7_6 f_7_7 f_8_1 f_8_2 f_8_3 f_8_4 f_8_5 f_8_6 f_8_7 f_1 f_2 f_3 f_4 f_6 f_7 f_8 ROLI {
	...
	foreach x of global `v'_tps {
		display as error "`x'" 
		gen dn_`v'_`x'= (d_`v'_`x'>=30 & d_`v'_`x'!=.)
		gen dp_`v'_`x'= (d_`v'_`x'<=-30 & d_`v'_`x'!=.)
}
}
...
gen positive_TPS=positive_TPS_n/91
gen negative_TPS=negative_TPS_n/91
...
*Dropping the highest experts for countries where the TPS say the scores are too positive (dif index - dif TPS <-30)
drop if rank_expert_p<4 & N>20 & N_questionnaire>5 & negative_TPS>=0.65
...
*Merging rankings from SCENARIO 2 (starting point of this scenario) - ALL COUNTRIES SHOULD MATCH
merge m:1 country using "$path2data\2. Scenarios\Alternative\qrq_rankings_s2_n.dta"
drop _merge
...
*Dropping the highest experts for countries where the TPS say the scores are too negative (dif index - dif TPS > 30)
drop if rank_expert_n<4 & N>20 & N_questionnaire>5 & positive_TPS_n>=0.65
