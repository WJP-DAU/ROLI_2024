...
import excel "$path2data\CJ Long 2024", sheet("Worksheet") firstrow clear
...
**We are keeping the responses from last year (_cj)
...
save "$path2exp\Long\cj_final_long_2023.dta", replace
