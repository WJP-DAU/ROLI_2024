...
import excel "$path2data\PH Long 2024", sheet("Worksheet") firstrow clear
...
**We are keeping the responses from last year (_ph)
...
save "$path2exp\Long\ph_final_long_2023.dta", replace
