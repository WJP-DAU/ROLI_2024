...
*Merging rankings from SCENARIO 0 (starting point of this scenario) - ALL COUNTRIES SHOULD MATCH
merge m:1 country using "$path2data\2. Scenarios\Proportions\qrq_rankings_s0.dta"
drop _merge
